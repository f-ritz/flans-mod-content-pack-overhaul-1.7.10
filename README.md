...
No armor, vehicles, or team functionality are present, but may be added soon.
...
My gaming days are largely behind me, and I wanted to put this out there, lest the flash drive I've been holding onto this in dies or disappears one day, in case anybody else wants to enjoy it.

### Credits
This gun content pack overhaul stands on the shoulders of giants who came before me. Content packs and mods whose contents were used in whole and/or in part include, with their original links (if available):
